...
<body class="bg-gray-100 font-sans leading-normal tracking-normal">
    <div class="flex flex-col md:flex-row">
        <!-- Sidebar -->
        <nav class="bg-gray-800 md:w-64 w-full md:min-h-screen flex-shrink-0">
            <div class="p-4">
            ...
            <header class="bg-white shadow">
                <div class="max-w-7xl mx-auto py-6 px-4 sm:px-6 lg:px-8 flex justify-between items-center">
                    ...
                    <h1 class="text-3xl font-bold text-gray-900">
                        @yield('header', 'Masuk atau Daftar')
                    </h1>
                    @endguest
                    ...
                    <div class="flex items-center">
                        <div class="mr-4 flex gap-x-3">
                            <div class="pl-2 pr-4 py-2 bg-blue-100 ring-1 ring-blue-600 text-blue-700 rounded flex gap-x-1 items-center">
                                ...
                                {{ Auth::user()->name}}</div>
                            <div class="pl-2 pr-4 py- bg-yellow-100 ring-1 ring-yellow-600 text-yellow-700 rounded flex gap-x-1 items-center">
                    ...
                    @else
                    <div>
                        <a href="{{ route('login') }}" class="text-white hover:underline mr-4">Masuk</a>
                        <a href="{{ route('register') }}" class="text-white hover:underline">Daftar</a>
                    </div>
                    @endauth
                    {{-- @else
