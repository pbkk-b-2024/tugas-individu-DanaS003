...
@section('title', 'Manajemen Pengguna - POS Sederhana')

@section('content')
<div class="bg-white p-6 rounded-lg shadow-md">
    <div class="flex justify-between items-center mb-6">
        <h2 class="text-2xl font-bold">Manajemen Pengguna</h2>
        <a href="{{ route('pengguna.create') }}" class="bg-blue-500 text-white font-bold py-2 px-4 rounded hover:bg-blue-600">Tambah Pengguna</a>
    </div>
                ...
                <tr class="border-b border-gray-200 hover:bg-gray-100">
                    ...
                    <td class="py-3 px-6 text-center">
                        <div class="flex item-center justify-center">
                            <a href="{{ route('pengguna.edit', $user->id) }}" class="w-4 mr-2 transform hover:text-purple-500 hover:scale-110">
