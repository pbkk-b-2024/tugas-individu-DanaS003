            ...
            <table class="w-full table-auto">
                ...
                <tbody class="text-gray-600 text-sm font-light">
                    ...
                    <tr class="border-b border-gray-200 hover:bg-gray-100">
                        ...
                        <td class="py-3 px-6 text-center">
                            @if(auth()->user()->role == "pembeli")
                            <a href="{{ route('transaksi.detail', $transaksi->id) }}" class="bg-blue-500 text-white py-1 px-3 rounded-full text-xs hover:bg-blue-600">Detail</a>
                            @else
                            <a href="{{ route('transaksi.show', $transaksi->id) }}" class="bg-blue-500 text-white py-1 px-3 rounded-full text-xs hover:bg-blue-600">Detail</a>
                            @endif
                        </td>
                    </tr>
                    @endforeach
