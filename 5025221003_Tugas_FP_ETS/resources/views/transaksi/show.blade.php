...
<div class="bg-white p-6 rounded-lg shadow-md">
    ...
    <div class="mt-8">
        @if(auth()->user()->role == "pembeli")
        <a href="{{ route('transaksi.list') }}" class="bg-blue-500 text-white font-bold py-2 px-4 rounded-lg hover:bg-blue-600">Lihat Daftar Transaksi</a>
        @else
        <a href="{{ route('transaksi.index') }}" class="bg-blue-500 text-white font-bold py-2 px-4 rounded-lg hover:bg-blue-600">Kembali ke Daftar Transaksi</a>
        @endif
    </div>
</div>
@endsection
